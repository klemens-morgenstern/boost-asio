...
BOOST_INLINE_CONSTEXPR auto& error = std::placeholders::_1;
BOOST_INLINE_CONSTEXPR auto& bytes_transferred = std::placeholders::_2;
BOOST_INLINE_CONSTEXPR auto& iterator = std::placeholders::_2;
BOOST_INLINE_CONSTEXPR auto& results = std::placeholders::_2;
BOOST_INLINE_CONSTEXPR auto& endpoint = std::placeholders::_2;
BOOST_INLINE_CONSTEXPR auto& signal_number = std::placeholders::_2;
